            ...
            <div className="flex flex-col py-4 mx-auto px-16 lg:flex-row divide-gray-400">
                ...
                <div className="flex flex-col justify-center lg:pt-0">
                    <div className="flex justify-center space-x-4">
                        <a rel="noopener noreferrer" target="_blank" href="https://www.instagram.com/_harry_tran/" title="Instagram" className="bg-indigo-500 text-white flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 ">
                        ...
                        <a rel="noopener noreferrer" target="_blank" href="https://twitter.com/TrnQuAn19" title="Twitter" className="bg-indigo-500 text-white flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10">
                        ...
                        <a rel="noopener noreferrer" target="_blank" href="https://www.facebook.com/tquean/" title="Facebook" className="bg-indigo-500 text-white flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-4 h-4">
                                <path d="M32 16c0-8.839-7.167-16-16-16-8.839 0-16 7.161-16 16 0 7.984 5.849 14.604 13.5 15.803v-11.177h-4.063v-4.625h4.063v-3.527c0-4.009 2.385-6.223 6.041-6.223 1.751 0 3.584 0.312 3.584 0.312v3.937h-2.021c-1.984 0-2.604 1.235-2.604 2.5v3h4.437l-0.713 4.625h-3.724v11.177c7.645-1.199 13.5-7.819 13.5-15.803z" />
                            </svg>
                        </a>
                        <a rel="noopener noreferrer" target="_blank" href="mailto:tquean15012003@gmail.com" title="Email" className="bg-indigo-500 text-white flex items-center justify-center w-10 h-10 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                                <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
                                <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path>
                            </svg>
                        </a>
                        <a rel="noopener noreferrer" target="_blank" href="https://github.com/tquean15012003" title="GitHub" className="bg-indigo-500 text-white flex items-center justify-center w-10 h-10 rounded-full">
