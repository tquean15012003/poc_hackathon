...
export default function CompanyManagement() {
  return (
    ...
    active
  " id="tabs-1-tab" data-bs-toggle="pill" data-bs-target="#tabs-1" role="tab" aria-controls="tabs-1" aria-selected="true">Program Department</a>
          </li>
          <li className="nav-item" role="presentation">
            <a href="#tabs-2" className="
    nav-link
    block
    font-medium
    text-xs
    ...
    hover:border-transparent hover:bg-gray-100
    focus:border-transparent
  " id="tabs-2-tab" data-bs-toggle="pill" data-bs-target="#tabs-2" role="tab" aria-controls="tabs-2" aria-selected="false">Liaison Department</a>
          </li>
          <li className="nav-item" role="presentation">
    ...
    hover:border-transparent hover:bg-gray-100
    focus:border-transparent
  " id="tabs-messages-tab" data-bs-toggle="pill" data-bs-target="#tabs-messages" role="tab" aria-controls="tabs-messages" aria-selected="false">Media Department</a>
          </li>
        </ul>
